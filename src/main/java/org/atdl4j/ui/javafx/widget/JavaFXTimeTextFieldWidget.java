 ...
 */
public class JavaFXTimeTextFieldWidget extends TextField {
    ...
    public JavaFXTimeTextFieldWidget() {
        this("00:00:00");
    }

    public JavaFXTimeTextFieldWidget(String time) {
        super(time);
        ...
        hours.bind(new JavaFXTimeTextFieldWidget.TimeUnitBinding(Unit.HOURS));
        minutes.bind(new JavaFXTimeTextFieldWidget.TimeUnitBinding(Unit.MINUTES));
        seconds.bind(new JavaFXTimeTextFieldWidget.TimeUnitBinding(Unit.SECONDS));
    }
