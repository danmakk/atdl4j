...
/**
 * Represents the base, non-GUI system-specific "TesterApp" core GUI component
 * (without a main() line).
 *
...
public abstract class AbstractAtdl4jTesterPanel
    ...
    /**
     * @param atdl4jInputAndFilterDataSelectionPanel the
     * atdl4jInputAndFilterDataSelectionPanel to set
     */
    ...
    public Atdl4jCompositePanel getAtdl4jCompositePanel() {
        if (atdl4jCompositePanel == null) {
            if (Atdl4jConfig.getConfig() == null) {
                Atdl4jConfig.setConfig(new JavaFXAtdl4jConfiguration());
            }
