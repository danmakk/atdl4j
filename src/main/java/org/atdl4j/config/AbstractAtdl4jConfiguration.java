...
/**
 * Typical setup (for class named XXX): private String classNameXXX; public void
 * setClassNameXXX(String); public String getClassNameXXX(); abstract protected
 * String getDefaultClassNameXXX(); public XXX getXXX() throws ; add to
 * constructor: setClassNameXXX( getDefaultClassNameXXX() ); NOTE: add public
 * XXX getXXX() to Atdl4jOptions NOTE: implement protected String
 * getDefaultClassNameXXX(); within derived classes
 *
 * Note that Class.forName()'s InstantiationException, IllegalAccessException,
 * ClassNotFoundException are rethrown as an Atdl4jClassLoadException
 *
 * This class contains the data associated with the
 * <code>AbstractAtdl4jConfiguration</code>.
 *
...
//TODO 9/26/2010 Scott Atwell	public static String DEFAULT_CLASS_NAME_STRATEGIES_UI_FACTORY = "org.atdl4j.ui.impl.BaseStrategiesUIFactory";
    ...
    /**
     * @param classNameAtdl4jWidgetFactory the classNameAtdl4jWidgetFactory to
     * set
     */
    ...
    /**
     * @param classNameTypeConverterFactory the classNameTypeConverterFactory to
     * set
     */
    ...
    /**
     * @param classNameAtdl4jWidgetForCheckBoxT the
     * classNameAtdl4jWidgetForCheckBoxT to set
     */
    ...
    /**
     * @param classNameAtdl4jWidgetForDropDownListT the
     * classNameAtdl4jWidgetForDropDownListT to set
     */
    ...
    /**
     * @param classNameAtdl4jWidgetForEditableDropDownListT the
     * classNameAtdl4jWidgetForEditableDropDownListT to set
     */
    ...
    /**
     * @param classNameAtdl4jWidgetForRadioButtonListT the
     * classNameAtdl4jWidgetForRadioButtonListT to set
     */
    ...
    /**
     * @param classNameAtdl4jWidgetForTextFieldT the
     * classNameAtdl4jWidgetForTextFieldT to set
     */
    ...
    /**
     * @param classNameAtdl4jWidgetForSliderT the
     * classNameAtdl4jWidgetForSliderT to set
     */
    ...
    /**
     * @param classNameAtdl4jWidgetForCheckBoxListT the
     * classNameAtdl4jWidgetForCheckBoxListT to set
     */
    ...
    /**
     * @param classNameAtdl4jWidgetForClockT the classNameAtdl4jWidgetForClockT
     * to set
     */
    ...
    /**
     * @param classNameAtdl4jWidgetForSingleSpinnerT the
     * classNameAtdl4jWidgetForSingleSpinnerT to set
     */
    ...
    /**
     * @param classNameAtdl4jWidgetForDoubleSpinnerT the
     * classNameAtdl4jWidgetForDoubleSpinnerT to set
     */
    ...
    /**
     * @param classNameAtdl4jWidgetForSingleSelectListT the
     * classNameAtdl4jWidgetForSingleSelectListT to set
     */
    ...
    /**
     * @param classNameAtdl4jWidgetForMultiSelectListT the
     * classNameAtdl4jWidgetForMultiSelectListT to set
     */
    ...
    /**
     * @param classNameAtdl4jWidgetForHiddenFieldT the
     * classNameAtdl4jWidgetForHiddenFieldT to set
     */
    ...
    /**
     * @param classNameAtdl4jWidgetForLabelT the classNameAtdl4jWidgetForLabelT
     * to set
     */
    ...
    /**
     * @param classNameAtdl4jWidgetForRadioButtonT the
     * classNameAtdl4jWidgetForRadioButtonT to set
     */
    ...
    /**
     * @param classNameStrategySelectionPanel the
     * classNameStrategySelectionPanel to set
     */
    ...
    /**
     * @param classNameStrategyDescriptionPanel the
     * classNameStrategyDescriptionPanel to set
     */
    ...
    /**
     * @param classNameFixatdlFileSelectionPanel the
     * classNameFixatdlFileSelectionPanel to set
     */
    ...
    /**
     * @param classNameAtdl4jUserMessageHandler the
     * classNameAtdl4jUserMessageHandler to set
     */
    ...
    /**
     * @param classNameAtdl4jInputAndFilterDataPanel the
     * classNameAtdl4jInputAndFilterDataPanel to set
     */
    ...
    /**
     * @param classNameAtdl4jInputAndFilterDataSelectionPanel the
     * classNameAtdl4jInputAndFilterDataSelectionPanel to set
     */
    ...
    /**
     * @param classNameAtdl4jCompositePanel the classNameAtdl4jCompositePanel to
     * set
     */
    ...
    /**
     * @param aClassNameStrategyPanelHelper the classNameStrategyPanelHelper to
     * set
     */
    ...
    /**
     * @param aCatchAllStrategyLoadExceptions the catchAllStrategyLoadExceptions
     * to set
     */
    ...
    /**
     * @param showCompositePanelOkCancelButtonSection the
     * showCompositePanelOkCancelButtonSection to set
     */
    ...
    /**
     * @param showTesterPanelOkCancelButtonSection the
     * showTesterPanelOkCancelButtonSection to set
     */
    ...
    private <E> E createClass(String aClassName) {
        if (aClassName == null) {
            throw new Atdl4jClassLoadException(aClassName);
        }
